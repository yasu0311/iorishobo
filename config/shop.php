...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | cod_free_threshold: クーポン適用後の商品合計（税込）がこの金額以上なら手数料 0 円。
    ...
    */
    ...
    'quantity_unit' => env('SHOP_QUANTITY_UNIT', '冊'),
    ...
    |--------------------------------------------------------------------------
    |
    | false のときストアフロントのクーポン入力を非表示にし、割引も適用しません。
    | 管理画面のクーポン管理は引き続き利用できます。
    |
    */

    'coupons_enabled' => (bool) env('SHOP_COUPONS_ENABLED', false),
