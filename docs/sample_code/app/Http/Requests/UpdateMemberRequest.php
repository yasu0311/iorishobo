...
class UpdateMemberRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = [
            'nickname' => [
                ...
                'string',
                'max:15',
                Rule::unique('members', 'nickname')->ignore(auth()->user()?->member?->id),
            ],
        ...
        if ($this->company == 1) {
            ...
            $rules['company_name_kana'] = 'nullable|string|max:100|regex:/^[ァ-ヶー\s]+$/u';
            ...
            $rules['company_phone_number'] = 'nullable|string|max:16|regex:/^[0-9-]+$/';
        }
    ...
    public function messages(): array
    {
        return [
            ...
            'company_phone_number.string' => '法人の電話番号は文字列で入力してください。',
